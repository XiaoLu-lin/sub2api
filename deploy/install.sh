...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/XiaoLu-lin/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="XiaoLu-lin/sub2api"
...
Documentation=https://github.com/XiaoLu-lin/sub2api
