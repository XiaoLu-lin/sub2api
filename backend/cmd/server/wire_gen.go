...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountStatusNotifier := service.ProvideAccountStatusNotifier(configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, accountStatusNotifier)
